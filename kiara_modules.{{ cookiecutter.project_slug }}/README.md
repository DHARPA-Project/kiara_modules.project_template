[![PyPI status](https://img.shields.io/pypi/status/kiara_modules.{{ cookiecutter.project_slug }}.svg)](https://pypi.python.org/pypi/kiara_modules.{{ cookiecutter.project_slug }}/)
[![PyPI version](https://img.shields.io/pypi/v/kiara_modules.{{ cookiecutter.project_slug }}.svg)](https://pypi.python.org/pypi/kiara_modules.{{ cookiecutter.project_slug }}/)
[![PyPI pyversions](https://img.shields.io/pypi/pyversions/kiara_modules.{{ cookiecutter.project_slug }}.svg)](https://pypi.python.org/pypi/kiara_modules.{{ cookiecutter.project_slug }}/)
...
[![Coverage Status](https://coveralls.io/repos/github/DHARPA-Project/kiara_modules.{{ cookiecutter.project_slug }}/badge.svg?branch=develop)](https://coveralls.io/github/DHARPA-Project/kiara_modules.{{ cookiecutter.project_slug }}?branch=develop)
